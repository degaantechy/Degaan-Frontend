...
const COPY = {
  en: {
    ...
    finishStandardText: 'This calculator is based on high-standard finishing. Final specifications and cost depend on the approved design, materials and site conditions.',
  ...
  so: {
    ...
    finishStandardText: 'Xisaabiyahani wuxuu ku salaysan yahay dhammaystir tayo sare leh. Faahfaahinta iyo qiimaha kama dambaysta ahi waxay ku xidhan yihiin naqshadda la ansixiyey, agabka iyo xaaladda goobta.',
