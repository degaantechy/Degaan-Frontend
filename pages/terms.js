  ...
  return (
    <>
      ...
      <main className="container trust-page">
        ...
        <h2>{so ? 'Dammaanad & defects' : 'Project warranties & defects'}</h2>
        <p>{so ? 'Muddada dammaanadda, defects liability, waxyaabaha ku jira iyo waxa ka reeban waxaa lagu qeexaa heshiiska mashruuca. Website-ku ma beddelayo shuruudaha qandaraaska mashruuc gaar ah.' : 'Warranty periods, defects-liability obligations, inclusions and exclusions are defined in the relevant project agreement. Website statements do not replace the terms of a project-specific contract.'}</p>
